...
//    Int nv = ndims[7];
    Int npv = ndims[9];
    Int porder = (app.porder[0]+app.porder[1]) / 2;
...
//        error("There are ghost vertices in the mesh.\n");
    ...
    for (currentElem = 0; currentElem < ne; currentElem++) {
        ...
        for (j = 0; j < nve; j++) {
            currentVertex = mesh.t[currentElem*nve+j];
    ...
    if (elemtype == 0) {
        for (currentElem = 0; currentElem < ne; currentElem++) {
            f1 = fieldVertices[mesh.t[currentElem*nve+0]];
            f2 = fieldVertices[mesh.t[currentElem*nve+1]];
            f3 = fieldVertices[mesh.t[currentElem*nve+2]];
        ...
        for (currentElem = 0; currentElem < ne; currentElem++) {
            ...
            f2 = fieldVertices[mesh.t[currentElem*nve+1]];
            f3 = fieldVertices[mesh.t[currentElem*nve+2]];
            f4 = fieldVertices[mesh.t[currentElem*nve+3]];
...
//    Int nv = ndims[7];
    Int npv = ndims[9];
    Int porder = (app.porder[0]+app.porder[1]+app.porder[2]) / 3;
    Int elemtype = getElemtype(nd, nve);
...
//    }
    ...
    if (elemtype == 0) {
        ...
        for (currentElem = 0; currentElem < ne; currentElem++) {
            ...
            f3 = fieldVertices[mesh.t[currentElem*nve+2]];
            f4 = fieldVertices[mesh.t[currentElem*nve+3]];
            f5 = fieldVertices[mesh.t[currentElem*nve+4]];
            f6 = fieldVertices[mesh.t[currentElem*nve+5]];
            f7 = fieldVertices[mesh.t[currentElem*nve+6]];
            f8 = fieldVertices[mesh.t[currentElem*nve+7]];
