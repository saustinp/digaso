#ifndef __GMRESPARLIB
#define __GMRESPARLIB
...
// }
// 
// static void orthogonalizempi_dp(double* c, double* q, double* Q, Int m, Int n, Int orthogMethod, 
...
// }
// 
// static void orthogonalizempi_sp(double* c, double* q, double* Q, float* q_sp, float* Q_sp, Int m, Int n, Int orthogMethod, 
...
// 
// 
// static void orthogonalizempi(double* c, double* q, double* Q, float* q_sp, float* Q_sp, 
...
//             blocksInPreconditioner = sys.ent2entStart[sys.numEntities];
