...
static Int decideThreadingLevel1(Int sz1, Int noThreads, Int precision)
{
...
static Int decideThreadingLevel2(Int noThreads, Int sz1, Int sz2, Int precision)
{
    // precision: Double: 1. Float: 2
...
static Int decideThreadingLevel3(Int noThreads, Int sz1, Int sz2, Int sz3, Int precision)
{
    // precision: Double: 1. Float: 2
...
static void DGEMV_OpenMP(char* ch, Int* m, Int* n, double* alpha, double* A, Int* lda, 
...
// static void DGEMVn_OpenMP(char* chn, Int* m, Int* n, double* alpha, double* A, Int* lda, 
...
// }
// 
// static void DGEMVt_OpenMP(char* cht, Int* m, Int* n, double* alpha, double* A, Int* lda, 
//         double* x, Int* incx, double* beta, double* y, Int* incy, vector<vector<double> >* ys, Int noThreads) 
// {
...
static void DSCAL_OpenMP(Int* m, double* alpha, double* x, Int* inc, Int noThreads)
{
    /* x <- alpha*x */
...
static void DAXPY_OpenMP(Int* m, double* alpha, double* x, Int* incx, double* y, Int* incy, Int noThreads)
{
    /* y <- alpha * x + y */
...
static double DNRM2_OpenMP(Int* m, double* x, Int* incx, Int noThreads)
{
...
static double DDOT_OpenMP(Int* m, double* x, Int* incx, double* y, Int* incy, Int noThreads)
{
    Int threading = decideThreadingLevel1(*m, noThreads, 1);
    double dot = 0.0;
...
static double DDOTMPI(Int m, double* x, Int incx, double* y, Int incy, Int noThreads) 
{
...
static void DGEMVMPI(char ch, Int m, Int n, double alpha, double* A, Int lda, double* x, Int incx, 
...
static void DGEMMMPI(char cha, char chb, Int m, Int n, Int k, double alpha, double* A, Int lda,
...
static void SGEMV_OpenMP(char* ch, Int* m, Int* n, float* alpha, float* A, Int* lda, 
...
// static void SGEMVn_OpenMP(char* chn, Int* m, Int* n, float* alpha, float* A, Int* lda, 
...
// }
// 
// static void SGEMVt_OpenMP(char* cht, Int* m, Int* n, float* alpha, float* A, Int* lda, 
//         float* x, Int* incx, float* beta, float* y, Int* incy, vector<vector<float> >* ys, Int noThreads) 
// {
//     // TODO: Not sure if this routines works properly, but that's irrelevant since it is not used anymore.
...
static void SSCAL_OpenMP(Int* m, float* alpha, float* x, Int* inc, Int noThreads)
{
    /* x <- alpha*x */
...
static void SAXPY_OpenMP(Int* m, float* alpha, float* x, Int* incx, float* y, Int* incy, Int noThreads)
{
    /* y <- alpha * x + y */
...
static float SNRM2_OpenMP(Int *m, float* x, Int* incx, Int noThreads)
{
    float x2 = 0.0;
    Int threading = decideThreadingLevel1(*m, noThreads, 2);
...
static float SDOT_OpenMP(Int *m, float* x, Int* incx, float* y, Int* incy, Int noThreads)
{
    float dot = 0.0;
    Int threading = decideThreadingLevel1(*m, noThreads, 2);
...
static double SDOTMPI(Int m, float* x, Int incx, float* y, Int incy, Int noThreads) 
{
...
static void SGEMVMPI(char ch, Int m, Int n, float alpha, float* A, Int lda, float* x, Int incx, 
...
static void SGEMMMPI(char cha, char chb, Int m, Int n, Int k, float alpha, float* A, Int lda,
