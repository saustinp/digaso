function [fh,fh_udg,fh_uh] = fbou2_electrondensity(ib,ui,nl,p,udg,odg,uh,param,factor,time)
%FHAT flux function
...
switch ib
    case 1 % Electrode: species set to homogeneous nuemann and potential set to dirichlet
        ...
        fh(:,2) = r.*tau .*(ui(:,2)-uh(:,2));
        fh_uh(:,2,2) = -r.*tau;        
    case 2  % Right "farfield"
        % Species + potential all have homogeneous neumann
        [fh,fh_udg,fh_uh] = fhat2_axisymmetric(nl,p,udg,odg,uh,param,factor,time);
