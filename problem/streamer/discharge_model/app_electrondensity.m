...
% 
initu_func_set = {@initu_func_electrons;@initu_func_ions;0;   0;0;0;    0;0;0};     % Fields of Q are left zero because they will be calculated in 'getq'.
...
for itime = 1:ntime
    ...
    fname_out = 'run020224_2/time' + string(itime+itime_restart);
    save(fname_out, "UDG");
