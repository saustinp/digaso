...
//               app.precPrecision app.matvecPrecision app.orthogPrecision app.adaptiveGMREStol app.flag];
    ...
    //sol.UDG2Write.resize(npe*ncu*nein);       // Only required if writeQflag = 1.
...
//     
    ...
    sys.NewtonMaxiter = app.problem[14];          // Maximum number of Newton/quasi-Newton iterations
    sys.trueNewtonMaxiter = app.problem[14];         // Maximum number of Newton iterations
    sys.maxiter = app.problem[15];             // Maximum number of GMRES iterations
    sys.restart = app.problem[16];              // Parameter k in GMRES(k)
