...
{	
    ...
    // output: sorted integer array without duplicate elements
...
static void uniqueiarray(vector<Int> & a, vector<Int> & b, Int len_b)
{	
    // input: integer array b
    // output: sorted integer array a without duplicate elements
...
// static void uniqueiarray(Int * len_a, vector<Int> & a, vector<Int> & b, Int len_b)
// {
//     // input: integer array b
//     // output: sorted integer array a without duplicate elements
//     
...
// 	newEnd = unique(a.begin(), a.end());
//     
//     *len_a = (Int) std::distance(a.begin(), newEnd);
//     
// //     // remove duplicate elements
// // 	a.erase(newEnd, a.end());
// }
...
// static vector<Int> iarray2datn(vector<Int> &a, Int n, Int m)
// {
//     Int i, j;
//     vector<Int> b(m*n,0); 
//     for (i = 0; i<n; i++)
...
static bool IsAinB(Int A, vector<Int> B, Int n)
{    
    Int AinB = 0;    
    for (Int i=0; i<n; i++)
        if (A == B[i]) {
...
static bool IsSubset(vector<Int> A, vector<Int> B, Int m, Int n)
{    
    Int AinB = 1;
    for (Int i=0; i<m; i++)
        if (IsAinB(A[i], B, n)==0) {
