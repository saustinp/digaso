...
// #include "../utilities/MKLwrapper.h"
// #include "../blaslapack/mkl/include/mkl.h"
...
struct sysstruct {
    ...
    Int maxBlocksPerRowP;   // Maximum number of blocks per row in the preconditioner
    Int minBlocksPerRow;    // Minimum number of blocks per row in the matrix of the linear system
    Int minBlocksPerRowP;   // Minimum number of blocks per row in the preconditioner
