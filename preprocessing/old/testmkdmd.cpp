...
int main(int argc, char** argv) 
{
    ...
    string fileout = string(argv[2]) + NumberToString(world_rank) + ".bin";        // Name of binary file to write the solution
...
//     if (my_rank==0) {
//         cout<<hdg<<endl;
//         print2iarray(&elem2ent[0], nfe, ne);
//     }
//     error("here");
...
//         print1iarray(&elemintfent[0], (Int) elemintfent.size());
        // only need to find interface elements
...
//         if (my_rank==0){
//             print2iarray(&dmdt2f[0], (Int) elempart.size(), nfe);
//         }            
//         error("here");
        ...
        domaindecomposition(dmd,elem2ent,elcon, t2t, t2f, elemall, entall, 
        ...
        //cout<< "rank: " << my_rank << endl;
        //Int nrows = round(((double) dmd.elemsend.size())/3);      
        //print2iarray(&dmd.elemsend[0], nrows, 3);
