...
{   
    ...
    Int i, j;
    vector<Int> intelem, intfelem, extelem, intent, intfent, extent, elemintfent;           
...
//         printiarray(intent);
    ...
    if (hdg==1) {// hdg 
        make_elconhdg(dmd.elcon, dmd.t2f, dmd.bcrs_rowent2elem, dmd.bcrs_colent2elem, 
            dmd.bcrs_rowent2ent, dmd.bcrs_colent2ent, dmd.entpart, elemmap,
            elconhdg, t2f, elementtype, nfes, npfs, nfemax, npfmax, nelem);
    }       
    else
        make_elconedg(dmd.elcon, dmd.t2f, dmd.bcrs_rowent2elem, dmd.bcrs_colent2elem, 
            dmd.bcrs_rowent2ent, dmd.bcrs_colent2ent, dmd.entpart, elemmap,
            elem2ent, t2f, elementtype, nfes, npfs, nfemax, npfmax, nelem);    
}
