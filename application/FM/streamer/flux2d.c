void flux2d(double *f, double *f_udg, double *pg, double *udg, double *param, double time, int ng, int nc, int ncu, int nd, int ncd)
{
	...
	for (int i = 0; i <ng; i++) {
		...
		double t15 = t5*t12*u1*2.3987;
		double t17 = param3*t5*t9*t14*u1*u6*u9*6.23662E-1;
		double t18 = t4*t5*t6*t11*x1*4.3628E-3;
		double t16 = -t15;
		f_udg[0*ng+i] = t5*t12*u6*x1*(-2.3987);
		f_udg[1*ng+i] = 0.0;
		f_udg[2*ng+i] = 0.0;
		f_udg[3*ng+i] = t5*t12*u9*x1*(-2.3987);
		f_udg[4*ng+i] = 0.0;
		f_udg[5*ng+i] = 0.0;
		f_udg[6*ng+i] = 0.0;
		f_udg[7*ng+i] = 0.0;
		...
		f_udg[28*ng+i] = 0.0;
		f_udg[29*ng+i] = 0.0;
		f_udg[30*ng+i] = x1*(t16+param3*t2*t5*t9*t14*u1*6.23662E-1+t4*t5*t9*t13*u4*u6*9.59816E-4);
		f_udg[31*ng+i] = 0.0;
		f_udg[32*ng+i] = x1;
		f_udg[33*ng+i] = x1*(t17+t4*t5*t9*t13*u6*u7*9.59816E-4);
		f_udg[34*ng+i] = 0.0;
		f_udg[35*ng+i] = 0.0;
		f_udg[36*ng+i] = 0.0;
		f_udg[37*ng+i] = 0.0;
		...
		f_udg[46*ng+i] = 0.0;
		f_udg[47*ng+i] = 0.0;
		f_udg[48*ng+i] = x1*(t17+t4*t5*t9*t13*u4*u9*9.59816E-4);
		f_udg[49*ng+i] = 0.0;
		f_udg[50*ng+i] = 0.0;
		f_udg[51*ng+i] = x1*(t16+param3*t3*t5*t9*t14*u1*6.23662E-1+t4*t5*t9*t13*u7*u9*9.59816E-4);
		f_udg[52*ng+i] = 0.0;
		f_udg[53*ng+i] = x1;
		// (ng,nch,nd,nc)
...
void fluxonly2d(double *f, double *pg, double *udg, double *param, double time, int ng, int nc, int ncu, int nd, int ncd)
{
	double param1 = param[0];
	double param2 = param[1];
	double param3 = param[2];
