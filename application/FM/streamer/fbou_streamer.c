...
void fbou_streamer(double *f, double *f_udg, double * f_uh, double *pg, double *udg, double *uhg, 
...
{    
    ...
    switch (nd) {
        case 2:            
            fbou2d(f, f_udg, f_uh, pg, udg, uhg, nl, ui, param, time, ib, numPoints, nc, ncu, nd, ncd, temp);
            break;
        default:
            exit(-1);
            break;
