...
void fbou_ehd_tof(double *f, double *f_udg, double * f_uh, double *pg, double *udg, double *uhg, 
...
{    
    ...
    switch (nd) {
        case 2:            
            fbou_ehd_tof2d(f, f_udg, f_uh, pg, udg, uhg, nl, ui, param, time, ib, numPoints, nc, ncu, nd, ncd);            
            break;
        case 3:
            fbou_ehd_tof3d(f, f_udg, f_uh, pg, udg, uhg, nl, ui, param, time, ib, numPoints, nc, ncu, nd, ncd);
            break;
        default:
            exit(-1);
            break;
