void flux_leuq3d(double *f, double *f_udg, double *pg, double *udg, appstruct &app, double *param, double time, int ng, int nc, int ncu, int nd, int ncd)
{
	double mu = param[0];
	...
	for (int i = 0; i <ng; i++) {
		...
		f[2*ng+i] = t7;
		f[3*ng+i] = t3;
		f[4*ng+i] = t5+mu*(q22+1.0)*2.0;
		f[5*ng+i] = t9;
		f[6*ng+i] = t7;
		f[7*ng+i] = t9;
		f[8*ng+i] = t5+mu*(q33+1.0)*2.0;
	...
	for (int i = 0; i <ng; i++) {
		...
		f_udg[29*ng+i] = 0.0;
		f_udg[30*ng+i] = 0.0;
		f_udg[31*ng+i] = lambda;
		f_udg[32*ng+i] = 0.0;
		f_udg[33*ng+i] = 0.0;
		f_udg[34*ng+i] = 0.0;
		f_udg[35*ng+i] = lambda;
		f_udg[36*ng+i] = 0.0;
		f_udg[37*ng+i] = mu;
		f_udg[38*ng+i] = 0.0;
		f_udg[39*ng+i] = mu;
		...
		f_udg[97*ng+i] = mu;
		f_udg[98*ng+i] = 0.0;
		f_udg[99*ng+i] = lambda;
		f_udg[100*ng+i] = 0.0;
		f_udg[101*ng+i] = 0.0;
		f_udg[102*ng+i] = 0.0;
		f_udg[103*ng+i] = lambda;
		f_udg[104*ng+i] = 0.0;
		f_udg[105*ng+i] = 0.0;
		f_udg[106*ng+i] = 0.0;
		f_udg[107*ng+i] = t3;
