...
#include "FM/streamer/fbou_streamer.c"
        ...
        solstruct &sol, tempstruct &temp, Int ib, Int ife, Int ie, Int quadchoice, Int computeJacobian, Int numPoints)
{
    ...
    switch (app.appname) {
        ...
        case 8:
            ...
            break;
        case 9:
            fbou_streamer(fh, fhn_u, fhn_uh, pg, udg, uhg, odg, nl, ui, mesh, master, app, sol, temp, ib, ife, ie, quadchoice, computeJacobian, numPoints);
            break;
        default: {
